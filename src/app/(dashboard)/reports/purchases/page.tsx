...
export default function PurchasesReportPage() {
  ...
  useEffect(() => {
    ...
    fetch(`/api/v1/reports/purchases?${qs}`)
      .then((r) => r.json())
      .then(setData)
  ...
  return (
    <ReportShell
      ...
      exportFilename={`purchases-${range.from}_${range.to}`}
      extraFilters={
        <div>
            ...
            <table className="table table-sm">
              ...
              <tbody>
                {loading ? (
                  ...
                  <tr><td colSpan={9} className="text-center py-8 text-base-content/50">No data</td></tr>
                )}
              </tbody>
            </table>
          </div>
